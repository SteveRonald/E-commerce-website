...
.account-wrapper {
    ...
    max-width: 1000vw; /* Prevent horizontal overflow */
    margin: 0;
    border-radius: 0;
    box-shadow: none;
    background: #fff;
...
.main-content {
    ...
    height: 100vh;      /* Make it same height as sidebar/browser */
    ...
    box-sizing: border-box;
        ...
        .profile-details b { color: #2f6b29; }
        .upload-form { margin-top: 10px; }
        .upload-form input[type="file"] { margin-bottom: 8px; }
        .msg {
            background: #e8f5e9;
            color: #2f6b29;
        ...
        .order-status.received { color: #e67e22; }
        .order-status.in_delivery { color: #2980b9; }
    ...
    <div class="main-content">
        ...
        <section id="orders-section" class="account-section">
            ...
            <?php else: ?>
                <table>
                    <tr>
                        <th>Product</th><th>Color</th><th>Qty</th><th>Unit Price</th><th>Total</th><th>Status</th><th>Date</th><th>Action</th>
                    </tr>
...
function initMap() {
    ...
    let defaultLatLng = { lat: -1.286389, lng: 36.817223 }; // Default: Nairobi
