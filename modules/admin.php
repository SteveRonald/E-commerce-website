...
<head>
    ...
    <style>
        ...
        .admin-layout {
            ...
            min-height: 100vh;
            height: 100vh;
            /* Make sure the layout fills the viewport */
            overflow: hidden;
            /* Prevent body scroll */
        }
        ...
        .main-content {
            ...
            height: 100vh;
            overflow: hidden;
            /* Prevent main-content from scrolling, only inner scrolls */
        }
        ...
        .admin-container {
            ...
            overflow-y: auto;
            height: 0;
            /* Allows flexbox to control height */
        }
                ...
                <?php elseif ($page === 'admins'): ?>
                    ...
                    <table>
                        <tr>
                            ...
                            <th>Email</th>
                            <th>Role</th>
                            <th>Status</th><?php if ($has_created_at): ?><th>Created</th><?php endif; ?><th>Action</th>
                        </tr>
